...
LABEL org.label-schema.name="php-phalcon-node" \
      org.label-schema.url="https://hub.docker.com/r/matshareyourscript/php-phalcon-node/" \
      org.label-schema.vcs-url="https://github.com/mat-shareyourscript/php-phalcon-node"
